...
tDFUI_translation["ruRU"] = {
  ...
  ["Adds a remaining cast time to the cast bar."] = "Добавляет время каста заклинания в полосу заклинаний",
  ...
  ["Improved Castbar"] = "Улучшения полосы заклинаний",
  ...
  ["Movable Unit Frames Extended"] = "Передвижные окна (доп)",
