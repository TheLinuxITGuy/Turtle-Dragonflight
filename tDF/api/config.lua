...
function ShaguPlates:LoadConfig()
  ...
  ShaguPlates:UpdateConfig("global",     nil,           "font_size",        "12")
  ShaguPlates:UpdateConfig("global",     nil,           "font_unit", "Fonts\\FRIZQT__.TTF")
  ShaguPlates:UpdateConfig("global",     nil,           "font_unit_size",   "12")
  ...
  ShaguPlates:UpdateConfig("nameplates", nil,           "heighthealth",     "8")
  ...
  ShaguPlates:UpdateConfig("nameplates", nil,           "targetzoom",       "0")
  ShaguPlates:UpdateConfig("nameplates", nil,           "targetzoomval",    ".40")
  ShaguPlates:UpdateConfig("nameplates", nil,           "notargalpha",      ".75")
  ShaguPlates:UpdateConfig("nameplates", nil,           "healthtexture",    "Interface\\AddOns\\tDF\\img\\bar")
  ShaguPlates:UpdateConfig("nameplates", "name",        "fontstyle",        "OUTLINE")
  ShaguPlates:UpdateConfig("nameplates", "health",      "offset",           "-3")
