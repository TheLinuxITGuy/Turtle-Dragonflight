...
-- [ Skin Button ]
-- Applies ShaguPlates skin to buttons:
...
-- [ Skin Close Button ]
-- Applies ShaguPlates close skin to buttons and can also be positioned
...
-- [ Question Dialog ]
-- Creates a ShaguPlates user dialog popup:
...
-- [ Question Dialog ]
-- Creates a ShaguPlates infobox popup window:
-- 'text'       [string]        text that will be displayed.
