...
castbar.bg:SetWidth(203)
castbar.bg:SetHeight(38)
castbar.bg:SetPoint("TOPLEFT", castbar, "TOPLEFT", -1, 4)
...
castbar.bg2:SetWidth(203)
castbar.bg2:SetHeight(18)
castbar.bg2:SetPoint("TOPLEFT", castbar.bg, "TOPLEFT", 0, -3)
