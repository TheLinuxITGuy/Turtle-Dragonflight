ShaguPlates:RegisterModule("nameplates", "vanilla:tbc", function ()
  ...
  nameplates.OnCreate = function(frame)
    ...
    --print(ShaguPlates.media["img:dot"])
    nameplate.glow:Hide()
  ...
  nameplates.OnConfigChange = function(frame)
    ...
    --local hptexture = ShaguPlates.media["img:bar_gradient"]
    ...
    nameplate:SetPoint("TOP", parent, "TOP", 0, 40)
...
--local customFont = "Fonts\\FRIZQT__.TTF"
local customFont = "Interface\\AddOns\\tDF\\fonts\\Myriad-Pro.ttf"

-- Set custom font for plate.name
plate.name:SetFont(customFont, 10, "OUTLINE")
plate.name:SetText(name)

-- Set custom font for plate.level
plate.level:SetFont(customFont, 12, "OUTLINE")
